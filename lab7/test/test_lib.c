...
void test_func3()
{
    ...
    TEST_ASSERT_FLOAT_WITHIN(1e-2, 14.07, func3(2, pi, 3, 0, pi / 3));
}
...
void test_func8()
{
    ...
    TEST_ASSERT_FLOAT_WITHIN(1e-2, -8.39, func8(1, pi / 2, 2, 9, pi / 3));
    TEST_ASSERT_EQUAL_FLOAT(0.0, func8(0, pi, 0, 1, pi / 2));
}
